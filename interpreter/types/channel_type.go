...
func (v ChannelType) String() string {
	//TODO implement me
	return fmt.Sprintf("ChannelType %s", v.Value)
}
...
var _ChannelTypeMap = map[string]ChannelType {
	"CHANNEL_UNDEFINED": { imagick.CHANNEL_UNDEFINED },
	"CHANNEL_RED": { imagick.CHANNEL_RED },
	"CHANNEL_GRAY": { imagick.CHANNEL_GRAY },
	"CHANNEL_CYAN": { imagick.CHANNEL_CYAN },
	"CHANNEL_GREEN": { imagick.CHANNEL_GREEN },
	"CHANNEL_MAGENTA": { imagick.CHANNEL_MAGENTA },
	"CHANNEL_BLUE": { imagick.CHANNEL_BLUE },
	"CHANNEL_YELLOW": { imagick.CHANNEL_YELLOW },
	"CHANNEL_ALPHA": { imagick.CHANNEL_ALPHA },
	"CHANNEL_OPACITY": { imagick.CHANNEL_OPACITY },
	"CHANNEL_BLACK": { imagick.CHANNEL_BLACK },
	"CHANNEL_INDEX": { imagick.CHANNEL_INDEX },
	"CHANNEL_TRUE_ALPHA": { imagick.CHANNEL_TRUE_ALPHA },
	"CHANNELS_COMPOSITE": { imagick.CHANNELS_COMPOSITE },
	"CHANNELS_ALL": { imagick.CHANNELS_ALL },
	"CHANNELS_RGB": { imagick.CHANNELS_RGB },
	"CHANNELS_GRAY": { imagick.CHANNELS_GRAY },
	"CHANNELS_SYNC": { imagick.CHANNELS_SYNC },
	"CHANNELS_DEFAULT": { imagick.CHANNELS_DEFAULT },
}
