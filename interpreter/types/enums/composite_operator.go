...
var _CompositeOperatorMap = map[string]CompositeOperator{
	...
	"COMPOSITE_OP_ALPHA":             {imagick.COMPOSITE_OP_ALPHA, "COMPOSITE_OP_ALPHA"},
	...
	"COMPOSITE_OP_COPY_ALPHA":        {imagick.COMPOSITE_OP_COPY_ALPHA, "COMPOSITE_OP_COPY_ALPHA"},
	...
	"COMPOSITE_OP_HARD_MIX":          {imagick.COMPOSITE_OP_HARD_MIX, "COMPOSITE_OP_HARD_MIX"},
	"COMPOSITE_OP_HUE":               {imagick.COMPOSITE_OP_HUE, "COMPOSITE_OP_HUE"},
	"COMPOSITE_OP_IN":                {imagick.COMPOSITE_OP_IN, "COMPOSITE_OP_IN"},
	"COMPOSITE_OP_INTENSITY":         {imagick.COMPOSITE_OP_INTENSITY, "COMPOSITE_OP_INTENSITY"},
...
var _CompositeOperatorNames = []string{
	...
	"COMPOSITE_OP_HARD_MIX",
	"COMPOSITE_OP_HUE",
	"COMPOSITE_OP_IN",
	"COMPOSITE_OP_INTENSITY",
